-- Emma Rodriguez biomechanical analysis - using actual table structure
-- Fixed to match the real table columns
...
-- Create movement test for Emma - Squat Test (matching actual columns)
INSERT INTO movement_tests (
  ...
  skeleton_data, joint_angles, rom_measurements, completed_at, test_status
) VALUES (
  ...
  '["Limited ankle dorsiflexion (10° vs normal 20-25°)", "Poor hip control with valgus collapse", "Excessive trunk lean 45°"]', '["Knee valgus during descent", "Heel elevation", "Forward trunk lean"]',
  ...
  '2026-01-31 10:05:00', 'completed'
);

-- Create movement test for Emma - Balance Test
INSERT INTO movement_tests (
  assessment_id, test_name, test_category, test_order, instructions,
  status, score, movement_quality_score, ai_feedback, deficiencies, compensations_detected,
  skeleton_data, joint_angles, rom_measurements, completed_at, test_status
